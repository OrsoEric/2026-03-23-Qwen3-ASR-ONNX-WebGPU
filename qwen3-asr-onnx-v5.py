...
class Pipeline:
    ...
    def _run(self, i_cl_session, i_aan_input, i_x_return_ortvalues: bool = False):
    ...
    def transcribe(self, path, language=None):
        ...
        # PREFILL (KV stays on device)
        t0 = time.time()
        outputs = self._run(self.cl_onnx_decoder_init, {
            "input_embeds": emb,
            "position_ids": pos
        ...
        for _ in range(C_N_MAX_TOKENS):
            ...
            outputs = self._run(self.cl_onnx_decoder_step, {
