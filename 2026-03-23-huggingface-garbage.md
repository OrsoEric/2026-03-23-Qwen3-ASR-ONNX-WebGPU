(.venv) D:\Data\Project\Project-LLM\Runtime ONNX\2026-03-23 ONNX Qwen3 ASR>python onnx_inference.py "D:\Data\Project\Project-LLM\Audio Samples\SAMPLE-british-man-7s.wav" --onnx-dir "D:\LLM_Models\Qwen\Qwen3-ASR-0.6B-ONNX-CPU\onnx_models"
Loading ONNX models (decoder: INT8)...
Loading embeddings (622 MB)...
PyTorch was not found. Models won't be available and only tokenizers, configuration and file/data utilities can be used.        
Traceback (most recent call last):
  File "D:\Data\Project\Project-LLM\Runtime ONNX\2026-03-23 ONNX Qwen3 ASR\.venv\Lib\site-packages\transformers\models\auto\tokenization_auto.py", line 654, in from_pretrained
    config = AutoConfig.from_pretrained(
        pretrained_model_name_or_path, trust_remote_code=trust_remote_code, **kwargs
    )
  File "D:\Data\Project\Project-LLM\Runtime ONNX\2026-03-23 ONNX Qwen3 ASR\.venv\Lib\site-packages\transformers\models\auto\configuration_auto.py", line 1429, in from_pretrained
    config_dict, unused_kwargs = PreTrainedConfig.get_config_dict(pretrained_model_name_or_path, **kwargs)
                                
 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "D:\Data\Project\Project-LLM\Runtime ONNX\2026-03-23 ONNX Qwen3 ASR\.venv\Lib\site-packages\transformers\configuration_utils.py", line 574, in get_config_dict
    config_dict, kwargs = cls._get_config_dict(pretrained_model_name_or_path, **kwargs)
                          ~~~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "D:\Data\Project\Project-LLM\Runtime ONNX\2026-03-23 ONNX Qwen3 ASR\.venv\Lib\site-packages\transformers\configuration_utils.py", line 629, in _get_config_dict
    resolved_config_file = cached_file(
        pretrained_model_name_or_path,
    ...<9 lines>...
        _commit_hash=commit_hash,
    )
  File "D:\Data\Project\Project-LLM\Runtime ONNX\2026-03-23 ONNX Qwen3 ASR\.venv\Lib\site-packages\transformers\utils\hub.py", line 277, in cached_file
    file = cached_files(path_or_repo_id=path_or_repo_id, filenames=[filename], **kwargs)        
  File "D:\Data\Project\Project-LLM\Runtime ONNX\2026-03-23 ONNX Qwen3 ASR\.venv\Lib\site-packages\transformers\utils\hub.py", line 508, in cached_files        
    raise e
  File "D:\Data\Project\Project-LLM\Runtime ONNX\2026-03-23 ONNX Qwen3 ASR\.venv\Lib\site-packages\transformers\utils\hub.py", line 420, in cached_files        
    hf_hub_download(
    ~~~~~~~~~~~~~~~^
        path_or_repo_id,        
        ^^^^^^^^^^^^^^^^        
    ...
    ^
  File "D:\Data\Project\Project-LLM\Runtime ONNX\2026-03-23 ONNX Qwen3 ASR\.venv\Lib\site-packages\huggingface_hub\utils\_validators.py", line 89, in _inner_fn 
    return fn(*args, **kwargs)  
  File "D:\Data\Project\Project-LLM\Runtime ONNX\2026-03-23 ONNX Qwen3 ASR\.venv\Lib\site-packages\huggingface_hub\file_download.py", line 986, in hf_hub_download
    return _hf_hub_download_to_cache_dir(
        # Destination
    ...<15 lines>...
        dry_run=dry_run,        
    )
  File "D:\Data\Project\Project-LLM\Runtime ONNX\2026-03-23 ONNX Qwen3 ASR\.venv\Lib\site-packages\huggingface_hub\file_download.py", line 1158, in _hf_hub_download_to_cache_dir
    os.makedirs(os.path.dirname(blob_path), exist_ok=True)      
    ~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^      
  File "<frozen os>", line 217, in makedirs
  File "<frozen os>", line 217, in makedirs
  File "<frozen os>", line 227, in makedirs
FileNotFoundError: [WinError 3] The system cannot find the path specified: 'C:\\Users\\FatherOfMachines\\.cache\\huggingface\\hub'

During handling of the above exception, another exception occurred:

Traceback (most recent call last):
  File "D:\Data\Project\Project-LLM\Runtime ONNX\2026-03-23 ONNX Qwen3 ASR\onnx_inference.py", line 530, in <module>
    main()
    ~~~~^^
  File "D:\Data\Project\Project-LLM\Runtime ONNX\2026-03-23 ONNX Qwen3 ASR\onnx_inference.py", line 494, in main
    pipeline = OnnxAsrPipeline(onnx_dir=args.onnx_dir, num_threads=args.threads,
                               quantize=args.quantize)
  File "D:\Data\Project\Project-LLM\Runtime ONNX\2026-03-23 ONNX Qwen3 ASR\onnx_inference.py", line 249, in __init__
    self.tokenizer = SimpleTokenizer(str(tokenizer_path) if tokenizer_path else None)
                     ~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "D:\Data\Project\Project-LLM\Runtime ONNX\2026-03-23 ONNX Qwen3 ASR\onnx_inference.py", line 181, in __init__
    self.tokenizer = AutoTokenizer.from_pretrained("Qwen/Qwen3-ASR-0.6B")
                     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^
  File "D:\Data\Project\Project-LLM\Runtime ONNX\2026-03-23 ONNX Qwen3 ASR\.venv\Lib\site-packages\transformers\models\auto\tokenization_auto.py", line 658, in from_pretrained
    config = PreTrainedConfig.from_pretrained(pretrained_model_name_or_path, **kwargs)
  File "D:\Data\Project\Project-LLM\Runtime ONNX\2026-03-23 ONNX Qwen3 ASR\.venv\Lib\site-packages\transformers\configuration_utils.py", line 533, in from_pretrained
...
TASK: this worthless garbage try to use huggingface to download stuff in random places.